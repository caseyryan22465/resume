...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Relevant Coursework: Data Structures, Programming Methodology, Introduction to Computation, Introduction to Probability Theory/Statistics, Computer Systems Principles, Linear Algebra, and Multivariable Calculus}
        \resumeItem{3.67 GPA, John and Abigail Adams Scholarship Recipient}
